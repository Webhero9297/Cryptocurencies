...
This mechanism has been integrated into Bitcore-Node-Rim which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Rim-Project/insight-api-rim#web-socket-api](https://github.com/Rim-Project/insight-api-rim#web-socket-api) 
* API: [https://github.com/Rim-Project/insight-api-rim#swifttx-transactions](https://github.com/Rim-Project/insight-api-rim#swifttx-transactions) 
...
By default, the Rim Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rim Core daemon:
