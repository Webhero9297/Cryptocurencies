...
In order to support loading of multiple wallets in rim-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rim.cpp.
...
Changes to rim.cpp
----------------------
rim.cpp is the entry point into rim-qt, and as such, will require some minor modifications to provide hooks for
