...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        framePrivateSend->setMinimumSize(QSize(0, 350));
        ...
        formLayoutWidget = new QWidget(framePrivateSend);
        ...
        privatesendProgress = new QProgressBar(formLayoutWidget);
        ...
        formLayout->setWidget(1, QFormLayout::FieldRole, privatesendProgress);
        ...
        labelAnonymized->setText(QStringLiteral("0 RIM"));
        ...
        privatesendEnabled = new QLabel(formLayoutWidget);
        privatesendEnabled->setObjectName(QStringLiteral("privatesendEnabled"));

        formLayout->setWidget(0, QFormLayout::FieldRole, privatesendEnabled);

        runAutoDenom = new QPushButton(framePrivateSend);
        ...
        togglePrivateSend->setGeometry(QRect(120, 250, 221, 56));
        ...
        lineLastMessage = new QFrame(framePrivateSend);
        ...
        privatesendStatus = new QLabel(framePrivateSend);
        privatesendStatus->setObjectName(QStringLiteral("privatesendStatus"));
        privatesendStatus->setGeometry(QRect(10, 220, 451, 61));
        privatesendStatus->setMinimumSize(QSize(288, 43));
        privatesendStatus->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignTop);
        privatesendStatus->setWordWrap(true);
        privatesendAuto = new QPushButton(framePrivateSend);
        privatesendAuto->setObjectName(QStringLiteral("privatesendAuto"));
        privatesendAuto->setGeometry(QRect(10, 310, 221, 28));
        ...
        privatesendReset->setGeometry(QRect(230, 310, 221, 28));
        ...
        layoutWidget = new QWidget(framePrivateSend);
        ...
        labelPrivateSendSyncStatus = new QLabel(layoutWidget);
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Rim network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        ...
        labelAmountRounds->setText(QApplication::translate("OverviewPage", "0 RIM / 0 Rounds", Q_NULLPTR));
        ...
        privatesendEnabled->setText(QApplication::translate("OverviewPage", "Enabled/Disabled", Q_NULLPTR));
        runAutoDenom->setText(QString());
        togglePrivateSend->setText(QApplication::translate("OverviewPage", "Start/Stop Mixing", Q_NULLPTR));
        privatesendStatus->setText(QApplication::translate("OverviewPage", "(Last Message)", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        ...
        label_2->setText(QApplication::translate("OverviewPage", "PrivateSend", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelPrivateSendSyncStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Rim network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        label_4->setText(QApplication::translate("OverviewPage", "Recent transactions", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the Rim network after a connection is established, but this process has not completed yet.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
