...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        privatesendRounds = new QSpinBox(tabMain);
        ...
        horizontalLayout_4_Main->addWidget(privatesendRounds);
        ...
        anonymizeRim = new QSpinBox(tabMain);
        anonymizeRim->setObjectName(QStringLiteral("anonymizeRim"));
        anonymizeRim->setMinimum(100);
        anonymizeRim->setMaximum(100000);
        anonymizeRim->setSingleStep(100);
        anonymizeRim->setValue(1000);

        horizontalLayout->addWidget(anonymizeRim);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Rim after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Rim on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Rim to keep anonymized", Q_NULLPTR));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Rim client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Rim network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Rim.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/rim-project/rim-project-translations", Q_NULLPTR));
