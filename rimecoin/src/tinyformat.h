...
// this bearable tinyformat comes with a set of mrimos which are used
// internally to generate the API, but which may also be used in user code.
//
// The three mrimos TINYFORMAT_ARGTYPES(n), TINYFORMAT_VARARGS(n) and
// TINYFORMAT_PASSARGS(n) will generate a list of n argument types,
// type/name pairs and argument names respectively when called with an integer
// n between 1 and 16.  We can use these to define a mrimo which generates the
// desired user defined function with n arguments.  To generate all 16 user
// defined function bodies, use the mrimo TINYFORMAT_FOREACH_ARGNUM.  For an
...
// To keep it as transparent as possible, the mrimos below have been generated
...
// C++98 - define the interface functions using the wrapping mrimos
...
//------------------------------------------------------------------------------
// Define deprecated wrapping mrimo for backward compatibility in tinyformat
