...
#   c) node1 mines 32 blocks, so now node 0 has 500000IOX, node 1 has 4250IOX, node2 has none.
#   d) node0 sends 601 IOX to node2, in two transactions (301 IOX, then 300 IOX).
