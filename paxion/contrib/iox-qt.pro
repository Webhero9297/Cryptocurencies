...
RESOURCES += src/qt/iox.qrc src/qt/iox_locale.qrc

TRANSLATIONS += src/qt/locale/iox_bg.ts \
                src/qt/locale/iox_de.ts \
                src/qt/locale/iox_en.ts \
                src/qt/locale/iox_es.ts \
                src/qt/locale/iox_fi.ts \
                src/qt/locale/iox_fr.ts \
                src/qt/locale/iox_it.ts \
                src/qt/locale/iox_ja.ts \
                src/qt/locale/iox_pl.ts \
                src/qt/locale/iox_pt.ts \
                src/qt/locale/iox_ru.ts \
                src/qt/locale/iox_sk.ts \
                src/qt/locale/iox_sv.ts \
                src/qt/locale/iox_vi.ts \
                src/qt/locale/iox_zh_CN.ts \
                src/qt/locale/iox_zh_TW.ts
