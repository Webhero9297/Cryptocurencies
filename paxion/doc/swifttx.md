...
This mechanism has been integrated into Bitcore-Node-Iox which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/iox/insight-api-iox#web-socket-api](https://github.com/iox/insight-api-iox#web-socket-api)
* API: [https://github.com/iox/insight-api-iox#swifttx-transactions](https://github.com/iox/insight-api-iox#swifttx-transactions)
...
By default, the Iox Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Iox Core daemon:
