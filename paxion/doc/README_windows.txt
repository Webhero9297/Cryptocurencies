...
Intro
-----
Iox (IOX) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Iox utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run iox-qt.exe.

Iox Core is the original Iox client and it builds the backbone of the network.
However, it downloads and stores the entire history of Iox transactions;
