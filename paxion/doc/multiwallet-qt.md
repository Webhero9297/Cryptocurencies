...
In order to support loading of multiple wallets in iox-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is iox.cpp.
...
Changes to iox.cpp
----------------------
iox.cpp is the entry point into iox-qt, and as such, will require some minor modifications to provide hooks for
